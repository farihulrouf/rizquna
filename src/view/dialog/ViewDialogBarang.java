...
import com.silver.model.table.TableModelBarang3;
...
public class ViewDialogBarang extends JDialog {
  ...
  private TableModelBarang3 tableModel;
  ...
  public ViewDialogBarang() {
    setBackground(new Color(153, 153, 153));
    this.tableModel = new TableModelBarang3();
    init();
  }
  ...
  private void init() {
    ...
    this.textField.addKeyListener(new KeyAdapter() {
          public void keyTyped(KeyEvent e) {
            try {
              ViewDialogBarang.this.table.setModel((TableModel)ViewDialogBarang.this.tableModel);
              ViewDialogBarang.this.Cari();
          ...
          public void keyPressed(KeyEvent e) {
            ...
            switch (keyCode) {
              case 40:
                ViewDialogBarang.this.table.requestFocus();
                break;
              case 37:
                ViewDialogBarang.this.textField_1.requestFocus();
                break;
            } 
          }
        });
    ...
    this.table.addKeyListener(new KeyAdapter() {
          public void keyPressed(KeyEvent e) {
            if (e.getKeyCode() == 10) {
              e.consume();
              ViewDialogBarang.this.klik();
              ViewDialogBarang.this.dispose();
            } 
          }
        });
    ...
    this.table.setModel(new DefaultTableModel(
          ...
          (Object[])new String[] { "Barcode", "Barang", "Persediaan", "Harga Jual", "Diskon 1", "Diskon 2" }));
    ...
    this.textField_1.addKeyListener(new KeyAdapter() {
          public void keyTyped(KeyEvent e) {
            ...
            if ((karakter < '0' || karakter > '9' || 
              ViewDialogBarang.this.textField_1.getText().length() >= 14) && 
              karakter != '\b') {
              ViewDialogBarang.this.getToolkit().beep();
              e.consume();
              ViewDialogBarang.this.pesanEror();
            } 
          }
          ...
          public void keyPressed(KeyEvent e) {
            ...
            switch (keyCode) {
              case 39:
                ViewDialogBarang.this.textField.requestFocus();
                break;
            } 
          }
        });
    ...
    okButton.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            ViewDialogBarang.this.jButtonSaveActionPerformed(e);
          }
        });
  ...
  private void Cari() throws ErrorInfo, SQLException {
    ...
    this.tableModel.setList(dao.cariBarang(this.textField.getText()));
  }
  
  public ViewDialogBarang(AdminKasir parent, boolean modal) {
    setModal(true);
    this.tableModel = new TableModelBarang3();
    init();
  ...
  private void klik() {
    Barang modele = this.tableModel.get(this.table.getSelectedRow());
    setBarcode(modele.getId_barang());
  }
