...
public class cekStok extends JDialog {
  ...
  public cekStok() {
    ...
    this.textField.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent paramActionEvent) {
            cekStok.this.setBarcode(cekStok.this.textField.getText());
          }
        });
    ...
    this.textField.addKeyListener(new KeyAdapter() {
          public void keyPressed(KeyEvent e) {
            ...
            switch (keyCode) {
              case 40:
                cekStok.this.textField_2.requestFocus();
                break;
              case 39:
                cekStok.this.textPointField.requestFocus();
                break;
              case 10:
                cekStok.this.CariBarang();
                break;
            } 
          }
    ...
    this.textPointField.addKeyListener(new KeyAdapter() {
          public void keyPressed(KeyEvent e) {
            ...
            switch (keyCode) {
              case 37:
                cekStok.this.textField.requestFocus();
                break;
              case 40:
                cekStok.this.textField_2.requestFocus();
                break;
    ...
    this.textField_1.addKeyListener(new KeyAdapter() {
          public void keyPressed(KeyEvent e) {
            ...
            switch (keyCode) {
              case 38:
                cekStok.this.textField_2.requestFocus();
                cekStok.this.textField_2.selectAll();
                break;
              case 40:
                cekStok.this.textField_5.requestFocus();
                cekStok.this.textField_5.selectAll();
                break;
              case 37:
                cekStok.this.textField_1.requestFocus();
                break;
              case 39:
                cekStok.this.textField_12.requestFocus();
                break;
            } 
          }
        });
          ...
          public void keyPressed(KeyEvent e) {
            ...
            switch (keyCode) {
              ...
              case 37:
                ...
                break;
              case 39:
                cekStok.this.textField_3.requestFocus();
                break;
            } 
          }
        });
          ...
          public void keyPressed(KeyEvent e) {
            ...
            switch (keyCode) {
              ...
              case 37:
                ...
                break;
              case 39:
                cekStok.this.textField_4.requestFocus();
                break;
            } 
          }
        });
    ...
    this.textField_5.addKeyListener(new KeyAdapter() {
          public void keyPressed(KeyEvent e) {
            ...
            switch (keyCode) {
              case 38:
                cekStok.this.textField_1.requestFocus();
                cekStok.this.textField_1.selectAll();
                break;
              case 40:
                cekStok.this.textField_6.requestFocus();
                cekStok.this.textField_6.selectAll();
                break;
              case 37:
                cekStok.this.textField_1.requestFocus();
                cekStok.this.textField_1.selectAll();
          ...
          public void keyPressed(KeyEvent e) {
            ...
            switch (keyCode) {
              case 38:
                ...
                break;
              case 40:
                cekStok.this.textField_9.requestFocus();
                cekStok.this.textField_9.selectAll();
                break;
              case 37:
                cekStok.this.textField_1.requestFocus();
                break;
              case 39:
                cekStok.this.textField_7.requestFocus();
                cekStok.this.textField_7.selectAll();
                break;
            } 
          }
        });
    ...
    this.textField_7.addKeyListener(new KeyAdapter() {
          public void keyPressed(KeyEvent e) {
            ...
            switch (keyCode) {
              case 38:
                cekStok.this.textField_2.requestFocus();
                cekStok.this.textField.selectAll();
                break;
              case 40:
                cekStok.this.textField_5.requestFocus();
                break;
              case 37:
                ...
                break;
              case 39:
                cekStok.this.textField_8.requestFocus();
                cekStok.this.textField_8.selectAll();
                break;
            } 
          }
        });
          ...
          public void keyPressed(KeyEvent e) {
            ...
            switch (keyCode) {
              ...
              case 39:
                ...
                break;
              case 10:
                if (cekStok.this.textField_11.getText().equals("0"));
                break;
            } 
          }
        });
    ...
    this.scrollPane.setBounds(12, 312, 970, 300);
    ...
    this.textField_10.addKeyListener(new KeyAdapter() {
          public void keyTyped(KeyEvent e) {
            cekStok.this.table.setModel((TableModel)cekStok.this.tableModel);
            try {
              cekStok.this.Cari();
            } catch (ErrorInfo e1) {
              e1.printStackTrace();
  ...
  private void UpdatePBarang() {
    if (this.textPointField.getText().equals("")) {
      ...
      try {
        ...
        JOptionPane.showMessageDialog(this, "Sukses update");
        clear_data();
      } catch (SQLException e1) {
        e1.printStackTrace();
      } 
